package com.example.application.views.regalo;
...
@PageTitle("Regalo")
@Route(value = "regalo", layout = MainLayout.class)
@PermitAll
public class RegaloView extends Composite<VerticalLayout> {
